...
- <Product>에 없는 정보를 묻는 경우 "해당 내용은 확인이 어렵습니다"라고만 안내하라.
...
${LANGUAGE_RULE}`
  ...
  if (contextSource === 'single_product') {
    fewShotMessages = [
      ...
      {
        role: 'assistant',
        content: '현재 조회 중이신 상품을 안내해 드리겠습니다.\n\n**[상품명]**\n• 기본금리: 연 X.XX%\n• 가입기간: XX개월\n• 이자방식: 단리/복리\n\n우대금리 조건을 충족하시면 추가 금리 혜택을 받으실 수 있습니다.',
      },
    ]
    ...
    fewShotMessages = [
      ...
      {
        role: 'assistant',
        content: '죄송합니다. 해당 내용은 제공된 약관에서 확인되지 않습니다.',
      },
    ]
    ...
    fewShotMessages = [
      ...
      {
        role: 'assistant',
        content: '현재 정확한 금리는 상품 및 시장 상황에 따라 다르며, 저는 실시간 금리 정보를 제공하기 어렵습니다.',
      },
    ]
  }
