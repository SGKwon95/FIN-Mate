...
addCol('accounts', 'created_at',      "TEXT NOT NULL DEFAULT (datetime('now'))")
addCol('accounts', 'updated_at',      "TEXT NOT NULL DEFAULT (datetime('now'))")

addCol('transactions', 'account_id',                 'TEXT')
addCol('transactions', 'transaction_type',            "TEXT NOT NULL DEFAULT 'TRANSFER_IN'")
...
addCol('transactions', 'transacted_at',              "TEXT NOT NULL DEFAULT (datetime('now'))")
